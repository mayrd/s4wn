...
**Status:** S243 · 750 tests · WASM 300.1KB — Clippy: 0 errors, 0 warnings. 0 open issues. Added butterfly particle effect (colorful Forest/Grass daytime effect, 5 tests, wired into game loop). Next: replace BuildingType.name() calls in lib.rs JSON output with discriminant().**
