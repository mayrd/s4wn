...
1. **Visually confirm terrain fix** — On a machine with a working Chromium/Playwright browser, load a game and confirm terrain now shows textures (not black) with correct lighting/shading across elevation.
