...
Status: S279 · 793 tests · Clippy: 0 errors, 0 warnings. 0 open issues. WASM baseline: 295.9KB (S279 parse_map_json savings). All 10 name arrays are #[cfg(test)]-only. Next: (1) Consider alternative to serde_json data[66]=8.8KB encoding tables. (2) Phase 8: sound effects system (ambient water, weather, building sounds). (3) Migrate get_tile_at terrain/resource output from string names to integer discriminants. (4) Remove get_tile_at JSON format strings (last remaining terrain/resource name strings in WASM).
