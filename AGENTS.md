...
Status: S284 · 811 tests · Clippy: 0 errors, 0 warnings. 0 open issues. serde and serde_json fully removed from codebase. Next: (1) Phase 8: sound effects system (ambient water, weather, building sounds). (2) Migrate get_building_summary / get_unit_summary JSON to typed structs. (3) Investigate remaining WASM data[3]=15.7KB (shader source + building name strings in sav-parser). (4) Rebuild WASM and measure size reduction from serde removal.
