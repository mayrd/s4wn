...
| P51 | 2026-07-20 | **Main Menu Splash Background** — Main menu now uses splash.png as full-page background image with left overlay panel (280px) containing logo and buttons. Removed flex layout split view, simplified to `.main-menu-left` overlay on top of background. All 771 tests pass, TypeScript compiles clean. Pushed to GitHub.
