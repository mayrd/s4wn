...
1. **Building Placement — Click-on-Terrain Validation** — Add tile validity checks (territory ownership, terrain buildability, clear space) before placing a building. Show red tint on ghost mesh for invalid placement.
