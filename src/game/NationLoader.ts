...
const BUILT_IN_MANIFESTS: NationManifest[] = [
  {
    ...
    buildings: { categories: [], overrides: { keep: { category: 'military', model: 'models/buildings/keep.glb', texture: 'textures/buildings/stone.png', icon: 'icons/buildings/keep.png' }, sheep_ranch: { category: 'food', model: 'models/buildings/sheep_ranch.glb', texture: 'textures/buildings/thatch.png', icon: 'icons/buildings/sheep_ranch.png' }, vineyard: { category: 'food', model: 'models/buildings/vineyard.glb', texture: 'textures/buildings/timber.png', icon: 'icons/buildings/vineyard.png' }, wine_press: { category: 'food', model: 'models/buildings/wine_press.glb', texture: 'textures/buildings/stone.png', icon: 'icons/buildings/wine_press.png' } } }, balancing: { buildSpeedMultiplier: 1, unitTrainSpeedMultiplier: 1, resourceGatherMultiplier: 1,
  ...
  },
  {
    ...
    buildings: { categories: [], overrides: { keep: { category: 'military', model: 'models/buildings/keep.glb', texture: 'textures/buildings/timber.png', icon: 'icons/buildings/keep.png' }, pig_ranch: { category: 'food', model: 'models/buildings/pig_ranch.glb', texture: 'textures/buildings/thatch.png', icon: 'icons/buildings/pig_ranch.png' }, apiary: { category: 'food', model: 'models/buildings/apiary.glb', texture: 'textures/buildings/timber.png', icon: 'icons/buildings/apiary.png' }, mead_maker: { category: 'food', model: 'models/buildings/mead_maker.glb', texture: 'textures/buildings/stone.png', icon: 'icons/buildings/mead_maker.png' } } }, balancing: { buildSpeedMultiplier: 1, unitTrainSpeedMultiplier: 1, resourceGatherMultiplier: 1,
  ...
  },
  {
    ...
    buildings: { categories: [], overrides: { keep: { category: 'military', model: 'models/buildings/keep.glb', texture: 'textures/buildings/adobe.png', icon: 'icons/buildings/keep.png' }, goat_ranch: { category: 'food', model: 'models/buildings/goat_ranch.glb', texture: 'textures/buildings/thatch.png', icon: 'icons/buildings/goat_ranch.png' }, agave_farm: { category: 'food', model: 'models/buildings/agave_farm.glb', texture: 'textures/buildings/adobe.png', icon: 'icons/buildings/agave_farm.png' }, tequila_distillery: { category: 'food', model: 'models/buildings/tequila_distillery.glb', texture: 'textures/buildings/stone.png', icon: 'icons/buildings/tequila_distillery.png' }, powder_mill: { category: 'mining', model: 'models/buildings/powder_mill.glb', texture: 'textures/buildings/metal.png', icon: 'icons/buildings/powder_mill.png' } } }, balancing: { buildSpeedMultiplier: 1, unitTrainSpeedMultiplier: 1, resourceGatherMultiplier: 1.05,
  ...
  },
  {
    ...
    buildings: { categories: [], overrides: { keep: { category: 'military', model: 'models/buildings/keep.glb', texture: 'textures/buildings/marble.png', icon: 'icons/buildings/keep.png' }, goose_ranch: { category: 'food', model: 'models/buildings/goose_ranch.glb', texture: 'textures/buildings/thatch.png', icon: 'icons/buildings/goose_ranch.png' }, sunflower_field: { category: 'food', model: 'models/buildings/sunflower_field.glb', texture: 'textures/buildings/adobe.png', icon: 'icons/buildings/sunflower_field.png' }, oil_press: { category: 'food', model: 'models/buildings/oil_press.glb', texture: 'textures/buildings/stone.png', icon: 'icons/buildings/oil_press.png' }, weapon_foundry: { category: 'military', model: 'models/buildings/weapon_foundry.glb', texture: 'textures/buildings/metal.png', icon: 'icons/buildings/weapon_foundry.png' }, donkey_ranch: { category: 'food', model: 'models/buildings/donkey_ranch.glb', texture: 'textures/buildings/thatch.png', icon: 'icons/buildings/donkey_ranch.png' } } }, balancing: { buildSpeedMultiplier: 1.05, unitTrainSpeedMultiplier: 1, resourceGatherMultiplier: 1,
  ...
  private static async discoverExternal(registry: NationRegistry): Promise<void> {
    ...
    if (!registry.get('dark')) {
      const darkManifest: NationManifest = {
        ...
        buildings: { categories: [], overrides: {} }, balancing: { buildSpeedMultiplier: 1.2, unitTrainSpeedMultiplier: 1.1, resourceGatherMultiplier: 1.1,
