# Dark Tribe Nation Pack

## Purpose
This folder is the complete asset pack for the **Dark Tribe** faction in S4WN.
...
├── models/                # 3D meshes
│   ├── buildings/         # Dark Tribe-themed building OBJ/GLB meshes
│   ├── decorations/       # Border posts, flags, and other scenery
│   └── units/             # Dark Tribe-themed unit GLB/OBJ meshes
...
This is the single source of truth for the Dark Tribe pack. It defines:
...
`src/game/NationValidator.ts`. The Dark Tribe pack must pass all validation rules.
