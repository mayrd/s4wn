...
## ui_medals.png (256×256)

Campaign/achievement medals – a row of small Roman-style medal icons (bronze, silver, gold) with laurel/gear/crown motifs.

```
A seamless horizontal strip of small Roman-style medal icons on solid bright green (#00FF00) background. Each medal is a circular/oval insignia in warm gold, silver, and bronze tones, with laurel wreath, gear, and crown motifs to represent campaign achievements. Medals should be evenly spaced, ~64px tall each, 4-5 across. Clean vector-flat style. NO text. Background must be solid bright green (#00FF00). 256 pixels wide, 256 pixels tall.
```
