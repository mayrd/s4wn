...
- 🚧 GPU model rendering — MODEL_VERTEX/FRAGMENT_SHADER with PBR lighting, model VAO/buffer management, `upload_model_to_gpu()`, `render_models()` draw pass with per-instance MVP. WASM exports: `add_model_instance()`, `clear_model_instances()`, `model_instance_count()`. 10 new tests, 354 total.
---
