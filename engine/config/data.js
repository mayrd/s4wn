window.S4WN_CONFIG = {
  "buildings": [
    ...
    {
      "id": "LargeAxeStatue",
      "name": "Large Axe Statue",
      "name_de": "Große Axtstatue",
      "category": "Zierobjekte",
      "planks": 2,
      "stone": 3,
      "gold": 2,
    ...
    {
      "id": "LargeEagleStatue",
      "name": "Large Eagle Statue",
      "name_de": "Große Adlerstatue",
      "category": "Zierobjekte",
      "planks": 2,
      "stone": 3,
      "gold": 2,
    ...
    {
      "id": "SmallAxeStatue",
      "name": "Small Axe Statue",
      "name_de": "Kleine Axtstatue",
      "category": "Zierobjekte",
      "planks": 1,
      "stone": 1,
      "gold": 1,
    ...
    {
      "id": "SmallEagleStatue",
      "name": "Small Eagle Statue",
      "name_de": "Kleine Adlerstatue",
      "category": "Zierobjekte",
      "planks": 1,
      "stone": 1,
      "gold": 1,
...
(function() {
    ...
    // English fallback names for resources
    const RES_EN = {};
    RES_EN["WoodLog"] = "Wood Log";
    RES_EN["PlankWood"] = "Plank (Wood)";
    RES_EN["Stone"] = "Stone";
    RES_EN["CoalOre"] = "Coal Ore";
    RES_EN["IronOre"] = "Iron Ore";
    RES_EN["GoldOre"] = "Gold Ore";
    RES_EN["SulfurOre"] = "Sulfur Ore";
    RES_EN["IronBar"] = "Iron Bar";
    RES_EN["GoldBar"] = "Gold Bar";
    RES_EN["Water"] = "Water";
    RES_EN["Grain"] = "Grain";
    RES_EN["Flour"] = "Flour";
    RES_EN["Fish"] = "Fish";
    ...
    RES_EN["Goat"] = "Goat";
    RES_EN["Goose"] = "Goose";
    RES_EN["Donkey"] = "Donkey";
    RES_EN["Grapes"] = "Grapes";
    RES_EN["Wine"] = "Wine";
    RES_EN["Honey"] = "Honey";
    RES_EN["Mead"] = "Mead";
    RES_EN["Agave"] = "Agave";
    RES_EN["Tequila"] = "Tequila";
    RES_EN["Sunflower"] = "Sunflower";
    RES_EN["SunflowerOil"] = "Sunflower Oil";
    RES_EN["Hammer"] = "Hammer";
    RES_EN["Pickaxe"] = "Pickaxe";
    RES_EN["Axe"] = "Axe";
    RES_EN["Saw"] = "Saw";
    RES_EN["Shovel"] = "Shovel";
    RES_EN["Scythe"] = "Scythe";
    RES_EN["FishingRod"] = "Fishing Rod";
    RES_EN["Sword"] = "Sword";
    RES_EN["Bow"] = "Bow";
    RES_EN["Armor"] = "Armor";
    RES_EN["Spear"] = "Spear";
    RES_EN["Battleaxe"] = "Battleaxe";
    RES_EN["Blowgun"] = "Blowgun";
    RES_EN["BackpackCatapult"] = "Backpack Catapult";
    RES_EN["Gunpowder"] = "Gunpowder";
