...
export const clear_building_rally_point: (a: number) => number;
export const clear_model_instances: () => void;
export const clear_particles: () => void;
...
export const editor_grid_enabled: () => number;
...
export const get_building_rally_point: (a: number) => [number, number];
...
export const particle_count: () => number;
...
export const set_building_rally_point: (a: number, b: number, c: number) => number;
...
export const spawn_combat_effect: (a: number, b: number) => void;
export const spawn_construction_effect: (a: number, b: number, c: number, d: number, e: number) => void;
export const spawn_leaf_effect: (a: number, b: number) => void;
export const spawn_particle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
export const spawn_particle_burst: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
export const spawn_smoke_effect: (a: number, b: number) => void;
