...
export class MapExportData {
    static __wrap(ptr) {
        const obj = Object.create(MapExportData.prototype);
        obj.__wbg_ptr = ptr;
        MapExportDataFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        MapExportDataFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_mapexportdata_free(ptr, 0);
    }
    /**
     * @returns {Float32Array}
     */
    elevation() {
        const ret = wasm.mapexportdata_elevation(this.__wbg_ptr);
        var v1 = getArrayF32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    height() {
        const ret = wasm.mapexportdata_height(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {Int32Array}
     */
    resource() {
        const ret = wasm.mapexportdata_resource(this.__wbg_ptr);
        var v1 = getArrayI32FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
        return v1;
    }
     ...
     */
    terrain() {
        const ret = wasm.mapexportdata_terrain(this.__wbg_ptr);
        var v1 = getArrayU8FromWasm0(ret[0], ret[1]).slice();
        wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
        return v1;
    }
     ...
     */
    width() {
        const ret = wasm.mapexportdata_width(this.__wbg_ptr);
        return ret >>> 0;
    }
}
if (Symbol.dispose) MapExportData.prototype[Symbol.dispose] = MapExportData.prototype.free;
 ...
 * @returns {MapExportData | undefined}
 */
export function export_map_json() {
    const ret = wasm.export_map_json();
    return ret === 0 ? undefined : MapExportData.__wrap(ret);
}
...
export function generate_map(map_type, width, height) {
    ...
    return MapExportData.__wrap(ret);
}
...
export function get_frametime_histogram() {
    const ret = wasm.get_frametime_histogram();
    var v1 = getArrayU32FromWasm0(ret[0], ret[1]).slice();
    wasm.__wbindgen_free(ret[0], ret[1] * 4, 4);
    return v1;
}
 ...
 */
export function rotate_camera_azimuth(delta_deg) {
    wasm.rotate_camera_azimuth(delta_deg);
}
 ...
 * @param {number} y
 */
export function set_camera_center(x, y) {
    wasm.set_camera_center(x, y);
}
 ...
 * @param {boolean} on
 */
export function set_show_full_map(on) {
    wasm.set_show_full_map(on);
}
...
const MapExportDataFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_mapexportdata_free(ptr, 1));
